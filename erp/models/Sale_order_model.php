...
class Sale_order_model extends CI_Model
{
    ...
    {
        $this->db->select('IF(erp_products.code != "", erp_products.code, erp_sale_order_items.product_code) as code, erp_categories.categories_note_id, erp_deliveries.*, IF(erp_products.name != "", erp_products.name, erp_sale_order_items.product_name) as description, delivery_items.quantity_received as qty, erp_companies.name, erp_units.name as unit, delivery_items.category_name as brand, delivery_items.option_id, product_variants.name as variant,product_variants.qty_unit, (erp_delivery_items.quantity_received * erp_product_variants.qty_unit) as variant_qty,sale_order_items.piece,sale_order_items.wpiece,sale_order_items.expiry,sale_items.expiry as sale_expiry');
