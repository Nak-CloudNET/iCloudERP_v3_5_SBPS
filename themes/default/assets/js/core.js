...
$(document).ready(function() {
    ...
    $('body').on('click', '.invoice_links td:not(:first-child, :nth-child(2), :last-child)', function () {
        ...
        var sdate = start_date!== '0000-00-00 00:00:00'?('/'+start_date):'';
        var edate = end_date!== '0000-00-00 00:00:00'?('/'+end_date):'';

        $('#myModal').modal({remote: site.base_url + 'sales/modal_views/' + $(this).parent('.invoice_links').attr('id') + sdate + edate });
        $('#myModal').modal('show');
    });
