                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="sdate" name="sdate" value="<?= trim($this->erp->fld($_POST['start_date'])); ?>">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="edate" name="edate" value="<?= trim($this->erp->fld($_POST['end_date'])); ?>">
                            </div>
                        </div>  
