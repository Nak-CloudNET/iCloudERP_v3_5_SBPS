...
<?php
echo form_open('reports/sales_detail_delivery_action', 'id="action-form"');
?>
<div class="box">
            ...
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <div class="form-group" style="padding-left:0">
                        <div class="controls"> <?php echo form_submit('submit_report', $this->lang->line("submit"), 'class="btn btn-primary" style="font-size:14px; padding: 6px 12px; margin:0;font-weight:unset; width:80px"'); ?> </div>
                    </div>
                    <!--<div class="form-group col-lg-1">
                        <div class="controls"> <?php /*echo form_submit('submit_report', $this->lang->line("reset"), 'class="btn btn-danger reset"'); */ ?> </div>
                    </div>-->
                    <?php echo form_close(); ?>
