                                ...
                                foreach ($barcodes as $item) {
                                    ...
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        if($style == 6) {
                                            ...
                                            echo '<div class="row">';
                                            echo '<div class="col-sm-9 col-xs-9"><div class="barcode_img rotate">';
                                            echo $item['barcode'];
                                            echo '</div></div>';
                                            if ($item['image']) {
                                            ...
                                            if ($item['name']) {
                                                echo '<div><p class="barcode_name rotate" style="margin-left: -40px !important">' . $item['name'] . '</p></div>';
                                            }
                                            echo '</div>';
                                            echo '</div>';
                                            ...
                                            if ($item['price']) {
                                                ...
                                                if ($item['currencies']) {
                                                    ...
                                                    echo '<div style="float:left; font-size: 22px; font-weight:bold; font-family:Times New Roman; padding-left: 0.5cm"><span>Price:</span></div>';

                                                    echo '<div style="float:right; font-size: 22px; font-weight:bold; font-family:Times New Roman; padding-right: 1cm">';
                                                    echo $item['price'];
                                                    echo '</div>';
                                                }
                                                echo '</p> ';
