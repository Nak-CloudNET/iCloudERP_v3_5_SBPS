            ...
            <?php if (!$Supplier || !$Customer) { ?>
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
						...
						<div class="btn-group">
                            <a href="<?= site_url('sales/invoice_return_sbps/' . $inv->id) ?>"
                               class="tip btn btn-primary" title="<?= lang('SBPS Creadit_Note') ?>">
                                <i class="fa fa-print"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('SBPS Creadit_Note') ?></span>
                            </a>
                        </div>
						<div class="btn-group">
