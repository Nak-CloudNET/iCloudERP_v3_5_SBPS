...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#amount_1').on('keyup change', function () {
            ...
            var us_paid_hidden = parseFloat($('#amount_hidden').val()-0);
            if(us_paid > us_paid_hidden){
                $('#amount_1').val(us_paid_hidden);
            }
    ...
    function loadItems() {
        ...
        if (__getItem('reitems')) {
            ...
            if (gtotal > balance) {
                ...
                $('#amount_hidden').val(formatDecimal(balance));
            } else {
                $('#amount_1').val(formatDecimal(gtotal));
                $('#amount_hidden').val(formatDecimal(gtotal));
													...
													<div class="payment">
														<div class="form-group">
                                                            ...
                                                            <input name="amount-paid" type="text" id="amount_1"
                                                                   ...
                                                                   value="<?= $inv->paid; ?>"/>
                                                            <input name="amount-paid_hidden" type="hidden" id="amount_hidden"
                                                                   class="pa form-control kb-pad amount"
                                                                   value="<?= $inv->paid; ?>"/>
														</div>
													</div>
