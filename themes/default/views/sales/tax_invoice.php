        ...
        <div class="col-xs-12" style="margin-top:10px">
            <table id="SLData" class="table table-bordered table-hover table-striped" style="width: 100%;">
                ...
                <?php if ($inv->shipping != 0) {
                    echo '<tr class="tr"><td colspan="' . $col . '" style="text-align:right;">ដឹកជញ្ចូន ' . lang("Delivery Charge") . '</td><td style="text-align:right;">' . $this->erp->formatMoney($inv->shipping) . '</td></tr>';
                }
                ?>
